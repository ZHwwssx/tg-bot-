...
def safe_send(chat_id, text, **kwargs):
    ...
    RP_QUESTIONS = [
      ...
      },
      {
          ...
          "valid": {"убийство машиной или с водительского места"},
      ...
      },
      {
          ...
          "valid": {"rp убийство с потерей персонажа", "рп убийство с потерей персонажа"},
      ...
      },
      {
          ...
          "valid": {"смерть игрока по правилам рп", "смерть игрока по правилам ролевой игры"},
